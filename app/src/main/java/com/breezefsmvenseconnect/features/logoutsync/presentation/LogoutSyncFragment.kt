...
import com.breezefsmvenseconnect.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefsmvenseconnect.features.billing.api.AddBillingRepoProvider
import com.breezefsmvenseconnect.features.billing.model.AddBillingInputParamsModel
...
import com.breezefsmvenseconnect.features.dashboard.presentation.ReasonDialog
...
import com.breezefsmvenseconnect.features.document.model.AddEditDocumentInputParams
import com.breezefsmvenseconnect.features.document.model.DocumentAttachmentModel
...
import com.breezefsmvenseconnect.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezefsmvenseconnect.features.orderhistory.model.*
...
import com.breezefsmvenseconnect.features.quotation.model.AddQuotInputModel
import com.breezefsmvenseconnect.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmvenseconnect.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefsmvenseconnect.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefsmvenseconnect.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefsmvenseconnect.features.timesheet.model.AddTimeSheetInputModel
...
import com.breezefsmvenseconnect.features.returnsOrder.ReturnRequest
import com.breezefsmvenseconnect.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log.zip").path);
