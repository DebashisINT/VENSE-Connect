...
import com.breezefsmvenseconnect.*
import com.breezefsmvenseconnect.R
import com.breezefsmvenseconnect.app.*
import com.breezefsmvenseconnect.app.NewFileUtils.browseDocuments
import com.breezefsmvenseconnect.app.NewFileUtils.getExtension
import com.breezefsmvenseconnect.app.domain.*
import com.breezefsmvenseconnect.app.types.DashboardType
import com.breezefsmvenseconnect.app.types.FragType
import com.breezefsmvenseconnect.app.types.TopBarConfig
import com.breezefsmvenseconnect.app.uiaction.DisplayAlert
import com.breezefsmvenseconnect.app.utils.*
import com.breezefsmvenseconnect.app.utils.AppUtils.Companion.isProfile
...
import com.breezefsmvenseconnect.features.NewQuotation.*
import com.breezefsmvenseconnect.features.NewQuotation.api.GetQuotRegProvider
import com.breezefsmvenseconnect.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefsmvenseconnect.features.SearchLocation.SearchLocationFragment
import com.breezefsmvenseconnect.features.SearchLocation.locationInfoModel
import com.breezefsmvenseconnect.features.TA.ViewAllTAListFragment
import com.breezefsmvenseconnect.features.achievement.AchievementFragment
import com.breezefsmvenseconnect.features.activities.presentation.*
import com.breezefsmvenseconnect.features.addAttendence.*
import com.breezefsmvenseconnect.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefsmvenseconnect.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefsmvenseconnect.features.addAttendence.model.GetReportToFCMResponse
import com.breezefsmvenseconnect.features.addAttendence.model.GetReportToResponse
import com.breezefsmvenseconnect.features.addAttendence.model.Leave_list_Response
import com.breezefsmvenseconnect.features.addorder.presentation.AddOrderFragment
...
import com.breezefsmvenseconnect.features.addshop.presentation.AddShopFragment
import com.breezefsmvenseconnect.features.addshop.presentation.OTPVerificationDialog
import com.breezefsmvenseconnect.features.addshop.presentation.ScanImageFragment
import com.breezefsmvenseconnect.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefsmvenseconnect.features.alarm.model.AlarmData
import com.breezefsmvenseconnect.features.alarm.presetation.AttendanceReportFragment
import com.breezefsmvenseconnect.features.alarm.presetation.PerformanceReportFragment
import com.breezefsmvenseconnect.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefsmvenseconnect.features.alarm.presetation.VisitReportFragment
import com.breezefsmvenseconnect.features.attendance.AttendanceFragment
import com.breezefsmvenseconnect.features.attendance.api.AttendanceRepositoryProvider
import com.breezefsmvenseconnect.features.attendance.model.AttendanceRequest
import com.breezefsmvenseconnect.features.attendance.model.AttendanceResponse
import com.breezefsmvenseconnect.features.averageshop.presentation.AverageShopFragment
import com.breezefsmvenseconnect.features.avgorder.presentation.AverageOrderFragment
import com.breezefsmvenseconnect.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefsmvenseconnect.features.beatCustom.TeamBeatListFragment
import com.breezefsmvenseconnect.features.billing.presentation.AddBillingFragment
import com.breezefsmvenseconnect.features.billing.presentation.BillingDetailsFragment
import com.breezefsmvenseconnect.features.billing.presentation.BillingListFragment
import com.breezefsmvenseconnect.features.changepassword.presentation.ChangePasswordDialog
import com.breezefsmvenseconnect.features.chat.model.ChatListDataModel
import com.breezefsmvenseconnect.features.chat.model.ChatUserDataModel
import com.breezefsmvenseconnect.features.chat.model.GroupUserDataModel
import com.breezefsmvenseconnect.features.chat.presentation.*
import com.breezefsmvenseconnect.features.chatbot.presentation.ChatBotFragment
import com.breezefsmvenseconnect.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefsmvenseconnect.features.chatbot.presentation.ReportsFragment
import com.breezefsmvenseconnect.features.chatbot.presentation.SelectLanguageDialog
...
import com.breezefsmvenseconnect.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefsmvenseconnect.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefsmvenseconnect.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefsmvenseconnect.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefsmvenseconnect.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefsmvenseconnect.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefsmvenseconnect.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefsmvenseconnect.features.damageProduct.ShopDamageProductListFrag
import com.breezefsmvenseconnect.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefsmvenseconnect.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefsmvenseconnect.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefsmvenseconnect.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefsmvenseconnect.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefsmvenseconnect.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefsmvenseconnect.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefsmvenseconnect.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefsmvenseconnect.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefsmvenseconnect.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefsmvenseconnect.features.device_info.presentation.DeviceInfoListFragment
import com.breezefsmvenseconnect.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefsmvenseconnect.features.document.DocumentRepoFeatureNewFragment
import com.breezefsmvenseconnect.features.document.presentation.DocumentListFragment
import com.breezefsmvenseconnect.features.document.presentation.DocumentTypeListFragment
import com.breezefsmvenseconnect.features.document.presentation.OpenFileWebViewFragment
import com.breezefsmvenseconnect.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefsmvenseconnect.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefsmvenseconnect.features.dymanicSection.presentation.DynamicListFragment
import com.breezefsmvenseconnect.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefsmvenseconnect.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefsmvenseconnect.features.home.presentation.HomeFragment
import com.breezefsmvenseconnect.features.homelocation.presentation.HomeLocationFragment
import com.breezefsmvenseconnect.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefsmvenseconnect.features.know_your_state.KnowYourStateFragment
import com.breezefsmvenseconnect.features.lead.LeadFrag
import com.breezefsmvenseconnect.features.lead.ViewLeadFrag
import com.breezefsmvenseconnect.features.leaveapplynew.LeaveHome
import com.breezefsmvenseconnect.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefsmvenseconnect.features.localshops.LocalShopListFragment
import com.breezefsmvenseconnect.features.localshops.LocalShopListMapFragment
import com.breezefsmvenseconnect.features.localshops.NearByShopsMapFragment
import com.breezefsmvenseconnect.features.location.*
import com.breezefsmvenseconnect.features.location.api.LocationRepoProvider
import com.breezefsmvenseconnect.features.location.model.*
import com.breezefsmvenseconnect.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefsmvenseconnect.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefsmvenseconnect.features.login.ShopFeedbackEntity
import com.breezefsmvenseconnect.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefsmvenseconnect.features.login.presentation.LoginActivity
import com.breezefsmvenseconnect.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefsmvenseconnect.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefsmvenseconnect.features.marketing.presentation.MarketingPagerFragment
import com.breezefsmvenseconnect.features.meetinglist.prsentation.MeetingListFragment
import com.breezefsmvenseconnect.features.member.MapViewForTeamFrag
import com.breezefsmvenseconnect.features.member.model.TeamLocDataModel
import com.breezefsmvenseconnect.features.member.model.TeamShopListDataModel
import com.breezefsmvenseconnect.features.member.presentation.*
import com.breezefsmvenseconnect.features.menuBeat.MenuBeatFrag
import com.breezefsmvenseconnect.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefsmvenseconnect.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefsmvenseconnect.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefsmvenseconnect.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefsmvenseconnect.features.myjobs.model.CustomerDataModel
import com.breezefsmvenseconnect.features.myjobs.presentation.*
import com.breezefsmvenseconnect.features.myorder.presentation.MyOrderListFragment
import com.breezefsmvenseconnect.features.myprofile.presentation.MyProfileFragment
...
import com.breezefsmvenseconnect.features.nearbyshops.model.ShopListResponse
import com.breezefsmvenseconnect.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefsmvenseconnect.features.nearbyshops.presentation.BeatListFragment
import com.breezefsmvenseconnect.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefsmvenseconnect.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefsmvenseconnect.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefsmvenseconnect.features.newcollection.CollectionDetailsStatusFragment
import com.breezefsmvenseconnect.features.newcollection.CollectionShopListFragment
import com.breezefsmvenseconnect.features.newcollection.NewCollectionListFragment
import com.breezefsmvenseconnect.features.newcollectionreport.*
import com.breezefsmvenseconnect.features.notification.NotificationFragment
import com.breezefsmvenseconnect.features.orderList.NewDateWiseOrderListFragment
import com.breezefsmvenseconnect.features.orderList.NewOrderListFragment
import com.breezefsmvenseconnect.features.orderList.OrderListFragment
import com.breezefsmvenseconnect.features.orderdetail.presentation.OrderDetailFragment
import com.breezefsmvenseconnect.features.orderhistory.ActivityMapFragment
import com.breezefsmvenseconnect.features.orderhistory.OrderhistoryFragment
import com.breezefsmvenseconnect.features.orderhistory.TimeLineFragment
import com.breezefsmvenseconnect.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefsmvenseconnect.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefsmvenseconnect.features.performance.GpsStatusFragment
import com.breezefsmvenseconnect.features.performance.PerformanceFragment
import com.breezefsmvenseconnect.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefsmvenseconnect.features.performance.model.UpdateGpsInputParamsModel
import com.breezefsmvenseconnect.features.performanceAPP.PerformanceAppFragment
import com.breezefsmvenseconnect.features.permissionList.ViewPermissionFragment
import com.breezefsmvenseconnect.features.photoReg.*
import com.breezefsmvenseconnect.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefsmvenseconnect.features.quotation.presentation.*
import com.breezefsmvenseconnect.features.reimbursement.presentation.*
import com.breezefsmvenseconnect.features.report.presentation.*
import com.breezefsmvenseconnect.features.returnsOrder.*
import com.breezefsmvenseconnect.features.settings.presentation.SettingsFragment
import com.breezefsmvenseconnect.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefsmvenseconnect.features.shopdetail.presentation.*
import com.breezefsmvenseconnect.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefsmvenseconnect.features.stock.StockDetailsFragment
import com.breezefsmvenseconnect.features.stock.StockListFragment
import com.breezefsmvenseconnect.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefsmvenseconnect.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefsmvenseconnect.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefsmvenseconnect.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefsmvenseconnect.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefsmvenseconnect.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefsmvenseconnect.features.survey.SurveyFrag
import com.breezefsmvenseconnect.features.survey.SurveyViewDtlsFrag
import com.breezefsmvenseconnect.features.survey.SurveyViewFrag
import com.breezefsmvenseconnect.features.task.presentation.AddTaskFragment
import com.breezefsmvenseconnect.features.task.presentation.CalenderTaskFragment
import com.breezefsmvenseconnect.features.task.presentation.EditTaskFragment
import com.breezefsmvenseconnect.features.task.presentation.TaskListFragment
import com.breezefsmvenseconnect.features.taskManagement.TaskManagementFrag
import com.breezefsmvenseconnect.features.taskManagement.ViewTaskManagementFrag
import com.breezefsmvenseconnect.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefsmvenseconnect.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefsmvenseconnect.features.timesheet.presentation.TimeSheetListFragment
import com.breezefsmvenseconnect.features.viewAllOrder.CartFragment
import com.breezefsmvenseconnect.features.viewAllOrder.OrderTypeListFragment
import com.breezefsmvenseconnect.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefsmvenseconnect.features.viewAllOrder.ViewCartFragment
import com.breezefsmvenseconnect.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefsmvenseconnect.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefsmvenseconnect.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefsmvenseconnect.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefsmvenseconnect.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefsmvenseconnect.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefsmvenseconnect.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefsmvenseconnect.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefsmvenseconnect.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefsmvenseconnect.features.viewPPDDStock.ViewStockFragment
import com.breezefsmvenseconnect.features.weather.presentation.WeatherFragment
import com.breezefsmvenseconnect.mappackage.MapActivity
import com.breezefsmvenseconnect.mappackage.MapActivityWithoutPath
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefsmvenseconnectlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezefsmvenseconnect/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefsmvenseconnectlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
